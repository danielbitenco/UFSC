		...
		buttonDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(dao.deleteAgenda(ag)){
					JOptionPane.showMessageDialog(null, "Livro deletado com sucesso!", "Mensagem", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(null, "Erro ao deletar o livro ou id inexistente", "Mensagem", JOptionPane.ERROR_MESSAGE);
				}
