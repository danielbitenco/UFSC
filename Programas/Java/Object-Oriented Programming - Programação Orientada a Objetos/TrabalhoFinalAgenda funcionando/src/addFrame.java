...
public class addFrame extends JFrame {
	...
	public addFrame() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(fieldName.getText().equals("") || fieldAddress.getText().equals("") )
					JOptionPane.showMessageDialog(null, "Campos com * sao obrigatórios!", "Mensagem", JOptionPane.ERROR_MESSAGE);
				else{
					boolean erro = false;		
		...
		btnSair.setBounds(303, 155, 89, 23);
		frameAdd.add(btnSair);
